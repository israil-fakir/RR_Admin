...
export default function PlanCard({ plan }) {
  ...
  const handleOrder = async (e, planId) => {
    ...
    try {
      setLoading(true);
      alert("are you confirm to place this order?")
  ...
  return (
    <div
      className={`bg-white rounded-2xl border-2 transition-all duration-300 hover:shadow-2xl hover:-translate-y-1 flex flex-col relative ${
        isPopular
    ...
    >
      ...
      <div className="p-8 flex flex-col flex-1">
        ...
        {/* Order Button */}
        <button
          className={`w-full py-3.5 rounded-xl font-semibold transition-all duration-300 flex items-center justify-center gap-2 shadow-md hover:shadow-xl ${
            isPopular
